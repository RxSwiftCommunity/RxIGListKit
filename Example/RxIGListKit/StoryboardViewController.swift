...
final class StoryboardViewController: UIViewController, StoryboardLabelSectionControllerDelegate {
    ...
    let objectSignal = BehaviorSubject<[Person]>(value: [])
    ...
    override func viewDidLoad() {
        ...
        let ds = RxListAdapterDataSource<Person>(sectionControllerProvider: { (_, _) -> ListSectionController in
